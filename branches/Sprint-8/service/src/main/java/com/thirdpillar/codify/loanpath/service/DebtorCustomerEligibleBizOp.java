...
public class DebtorCustomerEligibleBizOp  extends AbstractBusinessOperation {

    //~ Static fields/initializers -------------------------------------------------------------------------------------

    private static final Log LOG = LogFactory.getLog(DebtorCustomerEligibleBizOp.class);
    	...
    	EntityService es = new EntityService();
    	 if ((params != null) && (params.length > 0)) {
	    	 ...
	    	 for(DebtorCustomer debtCust : debtorCustomers){
	    		 WorkflowStatus debtStatus=(WorkflowStatus)LookupService.getResult("WorkflowStatus.byStatusKey", "statusKey", "DEBTOR_STATUS_ELIGIBLE");
